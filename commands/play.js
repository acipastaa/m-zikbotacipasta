...
module.exports = {
  ...
  options: [
    {
      name: "normal",
      description: "Diğer platformlardan müzik açın.",
      type: ApplicationCommandOptionType.Subcommand,
      options: [
        {
          name: "name",
          description: "müzik adını yaz.",
    ...
    {
      name: "playlist",
      description: "Çalma listenizin adını yazın.",
      type: ApplicationCommandOptionType.Subcommand,
      options: [
        {
          name: "name",
          description: "Oluşturmak istediğiniz oynatma listesinin adını yazın.",
          type: ApplicationCommandOptionType.String,
          required: true
        }
      ]
