...
module.exports = {
name: "playlist",
description: "Çalma listesi komutlarını yönetmenizi sağlar.",
options: [
{
name: "create",
description: "Çalma listesi oluştur.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
description: "Oluşturmak istediğiniz oynatma listesinin adını TW yazın.",
