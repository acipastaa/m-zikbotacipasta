...
module.exports = {
  name: "channel",
  description: "Botun kullanılabileceği kanalı veya kanalları belirlemenizi sağlar.",
  permissions: "0x0000000000000020",
  options: [{
    name: "add",
    description: "Bir komut kullanım kanalı ekleyin.",
    type: ApplicationCommandOptionType.Subcommand,
    options: [
      {
        name: 'channel',
        description: 'Bir metin kanalından bahsedin.',
  ...
  {
    name: "remove",
    description: "Komut kullanım kanalını kaldırma.",
    type: ApplicationCommandOptionType.Subcommand,
    options: [
      {
        name: 'channel',
